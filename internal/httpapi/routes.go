...
var stableRoutes = []route{
	...
	{http.MethodGet, "/indexes/bars", "stock.index.bars", "查询指数 K 线", validateBars},
	...
	{http.MethodGet, "/market/exchange-announcement", "stock.exchange-announcement", "查询交易所公告", nil},
	{http.MethodGet, "/market/announcement", "stock.announcement", "查询公告", nil},
